...
public:
	...
	Position(Board const& board, Move_List const& moves, Move_Evaluator const& evaluator, Perspective const& perspective) : m_board(board), m_move_list(moves), m_evaluator(evaluator), m_perspective(perspective) {}
	Position(Board const& board, Move_List const& moves, Move_Evaluator const& evaluator) : Position(board, moves, evaluator, Perspective{ 0,1,2 }) {}
...
private:
	...
	*/
	...
	Position() : Position(Board{}, Move_List{}, Move_Evaluator{}) {}
